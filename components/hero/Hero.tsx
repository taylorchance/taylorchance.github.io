    ...
    <div className="relative h-full w-full ">
      ...
      >
        <h1
          ...
          data-animation="text"
        >
          <span className="relative z-10">Hi, I&apos;m Taylor Chance</span>
        </h1>
        <h2
          ...
          data-animation="text"
        >
          I&apos;m a Software Engineer &amp; Business Builder that loves <span>Strategy,</span> <span>Design</span> and <span>Development</span>
        </h2>
